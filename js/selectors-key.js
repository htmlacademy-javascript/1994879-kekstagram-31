...
const commentInputElement = photoElement.querySelector('.social__footer-text');
...
export { commentsContainerElement, commentInputElement, commentsLoaderElement, commentsTotalElement, commentsShowElement};
